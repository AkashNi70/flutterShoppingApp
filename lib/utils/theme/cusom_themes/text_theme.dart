...
class ShopTextTheme{
  ...
  static TextTheme shopLightTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.3)),

  );
  static TextTheme shopDarkTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.3)),
