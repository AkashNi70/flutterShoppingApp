      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            //title and subtitle
            Text(ShopTexts.changeYourPasswordTitle, style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center),
            const SizedBox(height: ShopSizes.spaceBtwItems),
            Text(ShopTexts.changeYourPasswordSubTitle, style: Theme.of(context).textTheme.labelMedium, textAlign: TextAlign.center),
            const SizedBox(height: ShopSizes.spaceBtwSections),

            //buttons
            SizedBox(width: double.infinity, child: ElevatedButton(onPressed: (){}, child: const Text(ShopTexts.done))),
            const SizedBox(height: ShopSizes.spaceBtwSections),
